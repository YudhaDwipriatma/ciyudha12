          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <a href="<?=base_url('index.php/user')?>">
                        <p class="material-icons" ><img src="<?=base_url()?>assets/house.png"
                          class="img-circle" style="width: 30px;"><div
                          style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Home</div></p>
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/user.png"
                        class="img-circle" style="width: 30px;"><div style="margin-right: 90px;
                         margin-top: -33px; font-size: 15px; float: right;">Profil</div></p>
                      </a>
                  </li>
                  <li class="active">
                  <a href="<?=base_url('index.php/user/gallery')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/house.png"
                        class="img-circle" style="width: 30px;"><div
                        style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Gallery</div></p>
              ...
              <a href="<?=base_url('index.php/user/event')?>">
                  <p class="material-icons" ><img src="<?=base_url()?>assets/house.png"
                    class="img-circle" style="width: 30px;"><div
                    style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Event</div></p>
